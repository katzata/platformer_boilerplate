...
import vertex from "./sphere.vert";
import fragment from "./sphere.frag";
/* export default class Sphere extends PIXI.Filter {
	constructor() {
		super(vertex, fragment);
		this.uniforms.radius = 1;
		this.uniforms.sectorCount = 36;
		this.uniforms.stackCount = 18;
		this.uniforms.smooth = true;
		this.uniforms.vertices = [];
		this.uniforms.normals = [];
		this.uniforms.texCoords = [];
		this.uniforms.indices = [];
		this.uniforms.interleavedVertices = [];
		this.uniforms.stride = 32; // stride for interleaved vertices, always=32
		this.uniforms.aVertexPosition = [110, 110];
	}
	...
	apply(
		...
		_currentState?: PIXI.FilterState | undefined,
	) {
...
let Sphere = function (gl, radius = 1, sectors = 36, stacks = 18, smooth = true) {
	this.gl = gl;
	if (!gl) console.log("[WARNING] Sphere.constructor requires GL context as a param.");
...
///////////////////////////////////////////////////////////////////////////////
Sphere.prototype.computeFaceNormal = function (x1, y1, z1, x2, y2, z2, x3, y3, z3) {
...
// import type { Point, CLEAR_MODES, FilterSystem, RenderTexture, FilterState } from "@pixi/core";
...
// export default class Sphere extends Filter {
// 	public static readonly defaults: SphereOptions = {
// 		sectorStep: 5,
// 		stackStep: 5,
// 		sectorAngle: 5,
// 		radius: 200,
...
// 		// Object.assign(this, Sphere.defaults, options);
// 		console.log(this);
// 	}
...
// 	// 	clear?: CLEAR_MODES | undefined,
// 	// 	_currentState?: FilterState | undefined,
// 	// ): void {
